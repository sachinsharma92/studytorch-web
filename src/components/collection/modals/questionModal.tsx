    ...
    >
      <div className="card-modal">
        <div className="top-button-section">
          <Button href={props.onCancel} className="btn-outline">
              ...
              <div className="question-list">
                ...
                >
                  <Row>
                    <Col span={24}>
                      <Checkbox value="A">
                        A <span className="text-span">Option 1</span>
                      </Checkbox>
                    </Col>
                    <Col span={24}>
                      <Checkbox value="B">
                        B <span className="text-span">Option 2</span>
                      </Checkbox>
                    </Col>
                    <Col span={24}>
                      <Checkbox value="C">
                        C <span className="text-span">Option 3</span>
                      </Checkbox>
                    </Col>
                    <Col span={24}>
                      <Checkbox value="D">
                        D <span className="text-span">Option 4</span>
                      </Checkbox>
                    </Col>
                    <Col span={24}>
                      <Checkbox value="E">
                        E <span className="text-span">Option 5</span>
                      </Checkbox>
                    </Col>
                  </Row>
                </Checkbox.Group>
        ...
        <div className="button-bottom-section">
          <ButtonCustom
            ...
            title="Cancel"
          />
          <ButtonCustom type="primary" onClick={onSuccess} title="Submit" />
        </div>
      </div>
    </Modal>
  );
