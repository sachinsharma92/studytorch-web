...
function LoginScreen(props: LoginScreenProps) {
  ...
  let isLoggedIn = useSelector((state: IAppState) =>
    get(state, 'userState.isLoggedIn')
  );
        ...
        <Spin spinning={loading}>
          <div className="form-section">
            ...
            >
              ...
              >
                <Input placeholder="Type your e-mail or username " />
              </Form.Item>
